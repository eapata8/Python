...
class Gestion:
 ...
 def ajouterEtudiant(self):
    ...
    unEtudiant = Etudiant(nom=input("Quel est le nom de l'étudiant? "),prenom=input("Quel est son prénom? "))
    ...
    cours = input("Entrez les cours à ajouter séparés d'une virgule: ")
    unEtudiant.l_cours = cours.split(",")
